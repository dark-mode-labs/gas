defmodule Gas.Tags.RawTagTest do
  use ExUnit.Case, async: true
  alias Gas.Tags.RawTag
      ...
      assert parse(template) ==
               {
                 ...
                 %Gas.ParserContext{rest: "", line: 1, column: 32, mode: :normal}
               }
    end
      ...
      assert parse(template) ==
               {
                 ...
                 %Gas.ParserContext{column: 37, line: 1, mode: :normal, rest: ""}
               }
    end
  ...
  describe "Renderable impl" do
    test "raw tag prints everything inside" do
      ...
      assert Gas.Renderable.render(tag, context, []) == {" {{ yo }} ", context}
    end
  end
end
