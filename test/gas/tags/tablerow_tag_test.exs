defmodule Gas.Tags.TablerowTagTest do
  use ExUnit.Case, async: true

  alias Gas.Tags.TablerowTag
    ...
    test "tablerow" do
      ...
      assert parse(template) == {
               ...
               %TablerowTag{
                 ...
                 body: [
                   %Gas.Text{loc: %Loc{line: 1, column: 35}, text: "\n  "},
                   %Gas.Object{
                   ...
                   %Gas.Text{loc: %Loc{line: 2, column: 22}, text: "\n"}
                 ],
                 parameters: %{},
               ...
               %Gas.ParserContext{line: 3, mode: :normal, column: 18, rest: "\n", tags: nil}
             }
    end
               ...
               {:ok,
                %TablerowTag{
                  ...
                  enumerable: %Gas.Range{
                    ...
                    start: %Gas.Literal{loc: %Loc{line: 1, column: 19}, value: 1},
                    finish: %Gas.Literal{loc: %Loc{line: 1, column: 22}, value: 5}
                  },
                  parameters: %{},
                  body: [
                    %Gas.Text{loc: %Loc{line: 1, column: 27}, text: "\n  "},
                    %Gas.Object{
                      loc: %Loc{line: 2, column: 6},
                      argument: %Gas.Variable{
                        loc: %Loc{line: 2, column: 6},
